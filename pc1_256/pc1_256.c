...
static void assemble(uint8_t cle[32], S *state);

void pc1_256_encrypt_block(const uint8_t *key, const uint8_t *plain, uint8_t *cipher, size_t block_length)
{
    S state;
    uint8_t cle[32]; /* les variables sont definies de facon globale */
    ...
    for (size_t index = 0; index < block_length; index++)
    {
        ...
        for (int compte = 0; compte <= 31; compte++)
        {
...
static void assemble(uint8_t cle[32], S *state)
{
    ...
    (*state).x1a0[8] = (*state).x1a0[7] ^ ((cle[16] * 256) + cle[17]);
    code(state);
    (*state).inter = (*state).inter ^ (*state).res;

    (*state).x1a0[9] = (*state).x1a0[8] ^ ((cle[18] * 256) + cle[19]);
    code(state);
    (*state).inter = (*state).inter ^ (*state).res;

    (*state).x1a0[10] = (*state).x1a0[9] ^ ((cle[20] * 256) + cle[21]);
    code(state);
    (*state).inter = (*state).inter ^ (*state).res;

    (*state).x1a0[11] = (*state).x1a0[10] ^ ((cle[22] * 256) + cle[23]);
    code(state);
    (*state).inter = (*state).inter ^ (*state).res;

    (*state).x1a0[12] = (*state).x1a0[11] ^ ((cle[24] * 256) + cle[25]);
    code(state);
    (*state).inter = (*state).inter ^ (*state).res;

    (*state).x1a0[13] = (*state).x1a0[12] ^ ((cle[26] * 256) + cle[27]);
    code(state);
    (*state).inter = (*state).inter ^ (*state).res;

    (*state).x1a0[14] = (*state).x1a0[13] ^ ((cle[28] * 256) + cle[29]);
    code(state);
    (*state).inter = (*state).inter ^ (*state).res;

    (*state).x1a0[15] = (*state).x1a0[14] ^ ((cle[30] * 256) + cle[31]);
    code(state);
    (*state).inter = (*state).inter ^ (*state).res;
