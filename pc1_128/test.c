...
{
    uint8_t cle[17];
    memccpy(&cle, &"0123456789ABCDEF", 0, sizeof(cle));
    ...
    pc1_128_encrypt_block((const uint8_t *)&cle, (const uint8_t *)&plain, (uint8_t *)&cipher, sizeof(plain));
    printarray((const uint8_t *)&cipher, sizeof(cipher));

    pc1_128_decrypt_block((const uint8_t *)&cle, (const uint8_t *)&cipher, (uint8_t *)&plain, sizeof(plain));
    printarray((const uint8_t *)&plain, sizeof(plain));
}